...
def obter_caracteristicas():
    caracteristicas = {}
    caracteristicas['Desempenho'] = int(sys.stdin.readiline().strip())
    caracteristicas['Velocidade'] = int(sys.stdin.readiline().strip())
    caracteristicas['Custo'] = int(sys.stdin.readiline().strip())
